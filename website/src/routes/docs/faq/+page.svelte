<svelte:head>
  <title>FAQ - Tequalizer Dokumentation</title>
</svelte:head>
...
<article class="prose max-w-none">
  <h1>FAQ</h1>
  <p>Haufig gestellte Fragen zu Tequalizer.</p>
</article>
...
<div class="mt-8 space-y-3">
  {#each faqs as faq}
    <div class="collapse collapse-arrow bg-base-200 border border-base-300">
      <input type="checkbox" />
      <div class="collapse-title font-medium text-sm">{faq.q}</div>
...
<div class="mt-10 p-4 bg-base-200 border border-base-300 rounded-lg text-sm">
  Noch Fragen? Schreib an
  <a href="mailto:elias.klassen@offlimits-it.com" class="link link-primary">elias.klassen@offlimits-it.com</a>.
</div>
